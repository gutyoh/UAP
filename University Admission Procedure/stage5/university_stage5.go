...
func main() {
	...
	file, err := os.Open("C:\\Users\\mrgut\\Documents\\UAP\\University Admission Procedure\\stage5\\applicant_list.txt")
	if err != nil {
		log.Fatal(err)
	}
	defer file.Close()
	...
	for scanner.Scan() {
		...
		// grades, _ := strconv.ParseFloat(strings.Split(line, " ")[2], 64)
		//for _, g := range strings.Split(line, " ")[2:] {
		//	x, _ := strconv.ParseFloat(g, 64)
		//	var total float64
		//	total += x
		//}
